...
class LoadOrder:
	...
	def parse(self):
		...
		self.inact = self._getDataFolderContents()
	...
	def listToLoadOrder(self, loadOrder):
	...
	def save(self):
		...
		data = self._getDataFolderContents()
	...
	def _getDataFolderContents(self):
...
def getPluginsTXTPath(game='FO3'):
